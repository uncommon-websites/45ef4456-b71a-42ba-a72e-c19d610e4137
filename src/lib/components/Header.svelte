...
<header class="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
  <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
    ...
    <a href="/" class="flex items-center gap-2 text-2xl font-bold tracking-tight text-black">
      <svg width="22" height="28" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-7">
    ...
    <nav class="hidden md:flex items-center gap-8">
      <a href="#" class="text-sm font-medium text-gray-600 hover:text-black transition-colors">Platform</a>
      <a href="#" class="text-sm font-medium text-gray-600 hover:text-black transition-colors">Solutions</a>
      <a href="#" class="text-sm font-medium text-gray-600 hover:text-black transition-colors">Resources</a>
    </nav>

    <!-- Right Actions -->
    <div class="flex items-center gap-6">
      <a href="#" class="hidden md:block text-sm font-medium text-gray-600 hover:text-black transition-colors">Documentation</a>
      <a href="#" class="hidden md:block text-sm font-medium text-gray-600 hover:text-black transition-colors">Sign in</a>
      <a href="#" class="text-sm font-medium text-black hover:text-gray-600 transition-colors">Book a Demo</a>
    </div>
  </div>
</header>
